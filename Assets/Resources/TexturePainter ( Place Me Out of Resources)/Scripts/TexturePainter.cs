...
public class TexturePainter : MonoBehaviour {
	...
	int paintPercent = 0;    //Benim ekledigim kod satiri. Asset'e ait degil.
	public Text paintPercentText;    //Benim ekledigim kod satiri. Asset'e ait degil.
	bool FullPaint = false;    //Benim ekledigim kod satiri. Asset'e ait degil.

	private void Start()   //Benim ekledigim kod blogu. Asset'e ait degil.
	{
		PlayerPrefs.SetInt("paintPercent", 0);
		canvasTexture.DiscardContents();
	}
    void Update ()
	{
    ...
    void DoAction(){	
		...
		PlayerPrefs.SetInt("paintPercent", PlayerPrefs.GetInt("paintPercent") + 1);    //Benim ekledigim kod satiri. Asset'e ait degil.
	...
	//Sets the base material with an our canvas texture, then removes all our brushes
	void SaveTexture(){		
		brushCounter=0;
